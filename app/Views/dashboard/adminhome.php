...
<section id="services" class="services">
  ...
  <!-- Vendor JS Files -->
  <script src="<?php echo base_url('public/vendor/purecounter/purecounter_vanilla.js');?>"></script>
  ...
  <script src="<?php echo base_url('public/vendor/typed.js/typed.umd.js');?>"></script>
  <script src="<?php echo base_url('public/vendor/waypoints/noframework.waypoints.js');?>"></script>
